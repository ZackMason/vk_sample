...
draw_viewport(gfx::gui::im::state_t& imgui, viewport_t* viewport) {
    ...
    math::aabb_t<v2f> screens[4]{
        math::aabb_t<v2f>{v2f{0.0f}, v2f{h_split[0], v_split[0]} * ss},
        math::aabb_t<v2f>{v2f{h_split[0], 0.0f} * ss, v2f{1.0f, v_split[1]} * ss},
        math::aabb_t<v2f>{v2f{0.0f, v_split[0]} * ss, v2f{h_split[1], 1.0f} * ss},
        math::aabb_t<v2f>{v2f{h_split[1], v_split[1]} * ss, ss},
    };
    range_u64(i, 0, 4) {
