...
void bullet_on_hit(physics::rigidbody_t* self, physics::rigidbody_t* other, physics::collider_t* self_shape, physics::collider_t* other_shape) {
    auto* hit_entity = (ztd::entity_t*)other->user_data;
    auto* self_entity = (ztd::entity_t*)self->user_data;
    auto* world = (ztd::world_t*)self->api->user_world;
    b32 spawn_hit = 0;
    ...
    if (hit_entity->stats.character.health.max) {
        auto blood = ztd::db::environmental::blood_01;
        ...
        auto* event = ztd::new_event(world, self_entity, ztd::event_type::damage);
    ...
    if (spawn_hit) {
        auto* event = ztd::new_event(world, self_entity, ztd::event_type::hit);
        ...
        // auto* hole = ztd::tag_spawn(world, ztd::db::misc::bullet_hole, self->position);
...
ztd::entity_t* explosion_at_point(
    ...
    // auto explosion = ztd::db::particle::orb;
