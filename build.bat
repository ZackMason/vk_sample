...
if "%~1"=="physics" (
    cl %OptimizationFlags% -DGEN_LINK_PHYSICS_API_PHYSX=1 -DGEN_INTERNAL=0 %IncludeFlags% /I %PhysXInclude% %CompilerFlags% ..\src\app_physics.cpp -LD /link %PhysicsLinkFlags%
)
